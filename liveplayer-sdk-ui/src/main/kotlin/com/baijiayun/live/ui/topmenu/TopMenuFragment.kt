...
class TopMenuFragment : BasePadFragment() {
    ...
    override fun observeActions() {
        ...
        routerViewModel.isShowShare.observe(this, Observer {
            it?.let {
                fragment_pad_top_menu_share.visibility = if (it && routerViewModel.liveRoom.featureConfig.isShareEnable) View.VISIBLE else View.GONE
            }
        })
    ...
    private fun initView() {
        fragment_pad_top_menu_exit.setOnClickListener { routerViewModel.actionExit.value = Unit }
