...
//                Log.d("ChatMessageView", "onBindViewHolder: message id=" + message.getId() + "........message content=" + message.getContent() + ".....result=" + presenter.getTranslateResult(position));
                ...
                requestOptions = requestOptions.error(R.drawable.live_ic_emoji_holder)
                ...
                if (message instanceof UploadingImageModel) {
                    ...
                    RequestOptions requestOptions = new RequestOptions();
                    requestOptions = requestOptions.error(failedColorDrawable)
                            .override(size[0], size[1])
                            .placeholder(failedColorDrawable);
                    Glide.with(getContext()).load(new File(message.getUrl()))
                            .apply(requestOptions)
                    ...
                    Glide.with(getContext()).asBitmap()
                            .load(AliCloudImageUtil.getScaledUrl(message.getUrl(), AliCloudImageUtil.SCALED_MFIT, 300, 300))
                            .apply(requestOptions)
                            .into(target);
    ...
    private static class ImageTarget extends SimpleTarget<Bitmap> {
